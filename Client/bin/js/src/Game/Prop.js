...
var Prop = /** @class */ (function (_super) {
    ...
    function Prop(type) {
        ...
        _this.ape3 = "star2.png";
        _this.ape4 = "star3.png";
        _this.ape5 = "shield.png";
        _this.ape6 = "jiguang.png";
    ...
    Prop.prototype.onLoop = function () {
        ...
        if (this.maxDownSpeed <= 0) {
            //this.speedX = 0;
            this.speedX <= 0 ? this.speedX = 0 : this.speedX = this.speedX - 0.08;
        }
        ...
        if (this.speed == 0 && !this.isFadeOut && this.speedX == 0 && this.y >= GlobleFun.bgY - 5) {
