...
var Gold = /** @class */ (function (_super) {
    ...
    Gold.prototype.onload = function () {
     ...
     * 根据关卡和球的等级设置金币的价值
     */
    Gold.prototype.setgoldPrice = function () {
        var price = Math.floor(Math.random() * 100);
        this.Price = price;
    };
    Gold.prototype.onLoop = function () {
     ...
     * @param n
     */
    Gold.prototype.setDir = function (n) {
        this.direction = n;
        if (this.direction == 2) {
     ...
     * 更新玩家的金币数量
     */
    Gold.prototype.updataPlayerGold = function () {
        if (GlobleFun.isOver) {
            return;
        }
        if (this.itemType == 1) {
     ...
     * 删除金币并增加玩家的金币数量
     */
    Gold.prototype.removeFromParent = function () {
